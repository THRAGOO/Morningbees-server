...
class AppleLoginService : SocialLoginService() {
    ...
    override fun getEmailByToken(socialToken: String): String {
        ...
        if( payload["exp"].intValue() < System.currentTimeMillis()/1000 ) throw BadRequestException("apple token expire", ErrorCode.InvalidAccessToken, LogEvent.SocialLoginServiceProcessError.code, logger)
